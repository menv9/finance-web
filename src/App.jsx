...
const CoingameProfilePage = lazy(() => import('./pages/CoingameProfilePage'));
const CoingameRoomPage = lazy(() => import('./pages/CoingameRoomPage'));
const CoingameOwnRoomPage = lazy(() => import('./pages/CoingameOwnRoomPage'));
                  ...
                  <CoingameShell>
                    <Suspense fallback={<div style={{ color: '#1cff00', fontFamily: 'monospace', padding: '2rem' }}>Loading...</div>}>
                      <Routes>
                        ...
                        <Route path="/room" element={<CoingameOwnRoomPage />} />
                        <Route path="/coin/:coinId/room" element={<CoingameRoomPage />} />
                        ...
                        <Route path="/profile" element={<CoingameProfilePage />} />
